...
namespace BookFindingAndRatingSystem.Data.Migrations
{
    ...
    [Migration("20230709115039_AddingBirhtDatesToAutors")]
    partial class AddingBirhtDatesToAutors
    {
            ...
            modelBuilder.Entity("BookFindingAndRatingSystem.Data.Models.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("365606b6-91cc-462f-b38d-e384d7bdd8ce"),
                            AutorId = 6,
                            CategoryId = 8,
                        ...
                        new
                        {
                            Id = new Guid("dde66f05-9f52-46e1-a13d-f4891aaf8da0"),
                            AutorId = 1,
                            CategoryId = 8,
                        ...
                        new
                        {
                            Id = new Guid("ef0b5a0b-8467-4085-89fa-a68f3496f4ce"),
                            AutorId = 2,
                            CategoryId = 8,
                        ...
                        new
                        {
                            Id = new Guid("bb3bab06-8989-4f32-8307-f8a55a371d43"),
                            AutorId = 3,
                            CategoryId = 8,
                        ...
                        new
                        {
                            Id = new Guid("e1a9a6a8-3e75-4825-97cc-8bd2af168738"),
                            AutorId = 4,
                            CategoryId = 5,
                        ...
                        new
                        {
                            Id = new Guid("ac5e9819-9906-4edc-830d-483e9b00d91d"),
                            AutorId = 5,
                            CategoryId = 5,
